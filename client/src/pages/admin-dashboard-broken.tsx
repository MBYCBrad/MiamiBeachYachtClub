      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-gray-900/50 border-gray-700/50 backdrop-blur-xl">
          <CardHeader>
            ...
            <CardDescription>Authentication, permissions, and security policies</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-gray-800/30">
                <div>
                  <p className="text-white font-medium">Login Monitoring</p>
                  <p className="text-sm text-gray-400">Track admin login attempts</p>
                </div>
                <motion.div
                  whileTap={{ scale: 0.95 }}
                  className="w-12 h-6 bg-purple-500 rounded-full p-1 cursor-pointer"
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input 
                  defaultValue="Monaco Bay Yacht Club"
        ...
        <Card className="bg-gray-900/50 border-gray-700/50 backdrop-blur-xl">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              {[
                { label: 'New Member Registrations', description: 'Alert when new members join' },
                { label: 'Booking Confirmations', description: 'Notify on yacht reservations' },
                { label: 'Payment Failures', description: 'Alert on failed transactions' },
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-gray-800/30">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/30">Up to Date</Badge>
                </div>
                <p className="text-sm text-gray-400 mb-2">Last checked: 1 day ago</p>
                <Button size="sm" variant="outline" className="border-gray-600 hover:border-purple-500">
                  Check for Updates
                </Button>
              </div>
              ...
              <div className="p-4 rounded-xl bg-gray-800/30">
                ...
                <p className="text-sm text-gray-400 mb-3">Temporarily disable user access for maintenance</p>
